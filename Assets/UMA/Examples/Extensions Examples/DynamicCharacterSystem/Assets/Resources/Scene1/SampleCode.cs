...
namespace UMA.CharacterSystem.Examples
{
    public class SampleCode : MonoBehaviour
    {
        ...
        public void DynamicCreateClick()
        {
            ...
            TextAsset t = Resources.Load<TextAsset>("CharacterRecipes/b081fbc8-0e54-4755-99b4-3cd191a876b4");
		...
		private void TakeSnapshots(){
			...
			ScreenCapture.CaptureScreenshot ("shot"+count+".png");
        ...
        public void BuildMaleWorker(){
            ...
            fileHandler.EnsureAvatarUniqueness(avatarName);
        }
